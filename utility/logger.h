...
namespace logger {
  ...
  public:
     ...
     */
    void LogMessage(LogLevel level, const string& message, bool echoInStd, const string& loggerAlias="");

    /**
     * Writes log message with level DEBUG
     * @see LogMessage
     */
    void LogDebug(const string& message, bool echoInStd, const string& loggerAlias="");

    /**
     * Writes log message with level INFO
     * @see LogMessage
     */
    void LogInfo(const string& message, bool echoInStd, const string& loggerAlias="");

    /**
     * Writes log message with level WARNING
     * @see LogMessage
     */
    void LogWarning(const string& message, bool echoInStd, const string& loggerAlias="");

    /**
     * Writes log message with level ERROR
     * @see LogMessage
     */
    void LogError(const string& message, bool echoInStd, const string& loggerAlias="");
  ...
  class LogStream {
  public:
    LogStream(Logger::LogLevel level=Logger::LL_INFO, const string& alias="", bool echoInStd=true, Logger& logger=Logger::Get());
    template< typename T >
  ...
  public:
     ...
     */
    PrintLogger(const string& alias="", bool echoInStd=true, Logger& logger=Logger::Get());
