...
namespace ltr {
  ...
  const LinearCompositionScorer::ScorerAndWeight& LinearCompositionScorer::at(size_t i) const {
    return scorers_.at(i);
  }
  LinearCompositionScorer::ScorerAndWeight& LinearCompositionScorer::at(size_t i) {
    return scorers_.at(i);
  }
  const LinearCompositionScorer::ScorerAndWeight& LinearCompositionScorer::operator[](size_t i) const {
    return at(i);
  }
  LinearCompositionScorer::ScorerAndWeight& LinearCompositionScorer::operator[](size_t i) {
    return at(i);
  }

  void LinearCompositionScorer::add(const ScorerAndWeight& scorer_and_weight) {
    scorers_.push_back(scorer_and_weight);
  }

  void LinearCompositionScorer::add(IScorer::Ptr scorer, double weight) {
