...
namespace ltr {
  std::string FakeScorer::generateCppCode
    ...
    hpp_code.
      ...
      append(tab_str).
        ...
        append("(const std::vector< double >& features) { return 0.0; }\n").
      append(tab_str).
        append("};\n");
  ...
  std::string FakeScorer::generateJavaCode
    ...
    java_code.
      ...
      append(tab_str).
        ...
        append("(Vector<Double> features) { return 0.0; }\n").
      append(tab_str).
        append("}\n");
