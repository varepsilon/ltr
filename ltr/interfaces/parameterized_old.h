...
#ifndef LTR_INTERFACES_PARAMETERIZED_OLD_H_
#define LTR_INTERFACES_PARAMETERIZED_OLD_H_
...
class ParameterizedOld {
   ...
   */
  const ParametersContainerOld& parameters() {
    return parameters_;
  }
  /**
   ...
   */
  void copyParameters(const ParametersContainerOld& params) {
   ...
   */
  void addParametersGroup(const ParametersContainerOld& container,
                          const string& group) {
    parameters_.setGroup(container, group);
  }
  virtual ~ParameterizedOld() {}
};
};

#endif  // LTR_INTERFACES_PARAMETERIZED_OLD_H_
