...
#ifndef LTR_UTILITY_BOOST_MULTI_ARRAY_H_
#define LTR_UTILITY_BOOST_MULTI_ARRAY_H_
  ...
  public:
    MultiArray(const vector<int>& dimensions = vector<int>(DimensionsCount, 0)):
      data_(*dimensions.begin(),
            MultiArray<T, DimensionsCount - 1>(dimensions.begin() + 1,
                                               dimensions.end())),
    ...
    MultiArray(vector<int>::const_iterator dimensions_begin,
      ...
      data_(*dimensions_begin,
            MultiArray<T, DimensionsCount - 1>(dimensions_begin + 1,
                                               dimensions_end)),
...
#endif  // LTR_UTILITY_BOOST_MULTI_ARRAY_H_
